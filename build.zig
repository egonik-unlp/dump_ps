...
pub fn build(b: *std.Build) void {
    ...
    exe_mod.addImport("dump_ps_lib", lib_mod);
    ...
    const database = b.addModule("database", .{ .root_source_file = .{ .cwd_relative = "src/database.zig" } });
    const types = b.addModule("types", .{ .root_source_file = .{ .cwd_relative = "src/types.zig" } });
